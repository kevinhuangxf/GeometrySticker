...
def get_opts():
    ...
    parser.add_argument('--random_code', action='store_true', default=False)
    parser.add_argument('--use_code_decoder', action='store_true', default=False)
    parser.add_argument('--clip_prompt', type=str, default='green',
                        help='prompt for clipnerf')
    ...
    parser.add_argument('--limit_train_batches', type=float, default=1.0,
                        help='pytorch lightning limit_train_batches')
